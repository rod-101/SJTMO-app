...
const CloseIcon = () => (
  <Icon d={['M18 6L6 18', 'M6 6l12 12']} size={22} />
);
...
const UsersIcon = () => (
  <Icon d={['M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2', 'M23 21v-2a4 4 0 0 0-3-3.87', 'M16 3.13a4 4 0 0 1 0 7.75']}
    size={22}>
    <circle cx="9" cy="7" r="4" fill="none" stroke="currentColor" strokeWidth="1.9" />
  </Icon>
);
...
const FileTextIcon = () => (
  <Icon size={22}>
    ...
    <polyline points="14 2 14 8 20 8" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinejoin="round" />
    <line x1="16" y1="13" x2="8" y2="13" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    <line x1="16" y1="17" x2="8" y2="17" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    <line x1="10" y1="9" x2="8" y2="9" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
  </Icon>
);

const BarChartIcon = () => (
  <Icon size={22}>
    <line x1="18" y1="20" x2="18" y2="10" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    <line x1="12" y1="20" x2="12" y2="4"  stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    <line x1="6"  y1="20" x2="6"  y2="14" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    <line x1="2"  y1="20" x2="22" y2="20" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
  </Icon>
);
...
const CarIcon = () => (
  <Icon size={22}>
    ...
    <circle cx="7"  cy="17" r="2" fill="none" stroke="currentColor" strokeWidth="1.9" />
    <circle cx="17" cy="17" r="2" fill="none" stroke="currentColor" strokeWidth="1.9" />
  </Icon>
);

const MapPinIcon = () => (
  <Icon size={20} d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z">
    <circle cx="12" cy="10" r="3" fill="none" stroke="currentColor" strokeWidth="1.9" />
  </Icon>
);

const PhoneIcon = () => (
  <Icon size={20} d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.47 2 2 0 0 1 3.6 1.29h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.88a16 16 0 0 0 6.29 6.29l.95-.95a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
);

const MailIcon = () => (
  <Icon size={20}>
    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
    <polyline points="22,6 12,13 2,6" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinejoin="round" />
  </Icon>
);

const CheckCircleIcon = () => (
  <Icon size={28} d="M22 11.08V12a10 10 0 1 1-5.93-9.14">
    <polyline points="22 4 12 14.01 9 11.01" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinejoin="round" />
  </Icon>
);
...
const UserPlusIcon = () => (
  <Icon size={28}>
    ...
    <circle cx="8.5" cy="7" r="4" fill="none" stroke="currentColor" strokeWidth="1.9" />
    <line x1="20" y1="8" x2="20" y2="14" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    <line x1="23" y1="11" x2="17" y2="11" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
  </Icon>
);

const LayoutIcon = () => (
  <Icon size={28}>
    <rect x="3" y="3" width="18" height="18" rx="2" ry="2" fill="none" stroke="currentColor" strokeWidth="1.9" />
    <line x1="3"  y1="9"  x2="21" y2="9"  stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    <line x1="9"  y1="21" x2="9"  y2="9"  stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
  </Icon>
);
...
const ScaleIcon = () => (
  <Icon size={20}>
    <line x1="12" y1="3" x2="12" y2="21" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    <path d="M5 6l7-3 7 3" />
    ...
    <div>
      ...
      <nav className="lp-nav">
        <div className="lp-nav__inner">
          ...
          {/* Logo */}
          <a href="#home" className="lp-nav__logo" onClick={(e) => { e.preventDefault(); scrollTo('home'); }}>
            ...
            <div className="lp-nav__logo-text">
              ...
              <span className="lp-nav__logo-sub">San Jose Traffic Mgmt. Office</span>
            </div>
          </a>

          {/* Desktop Links */}
          <ul className="lp-nav__links">
            {[['home','Home'],['services','Services'],['how-it-works','How It Works'],['about','About'],['contact','Contact']].map(([id, label]) => (
              <li key={id}>
        ...
        <div className={`lp-nav__mobile ${menuOpen ? 'open' : ''}`}>
          ...
          <div className="lp-nav__mobile-actions">
            <button className="lp-btn lp-btn--outline" onClick={() => { setMenuOpen(false); navigate('/login'); }}>Sign In</button>
            <button className="lp-btn lp-btn--primary" onClick={() => { setMenuOpen(false); navigate('/login'); }}>Get Started</button>
          </div>
        </div>
      </nav>
        ...
        <div className="lp-hero__inner">
          <div>
            ...
            <h1 className="lp-hero__title">
              Efficient Traffic Management<br />
              <span>for a Safer San Jose</span>
            </h1>
            <p className="lp-hero__sub">
              A unified digital platform for citation issuance, enforcer coordination,
              and motorist services — making road safety faster, smarter, and more transparent.
            </p>
            <div className="lp-hero__cta">
              <button className="lp-btn lp-btn--hero-primary" onClick={() => navigate('/login')}>
                Sign In to Portal
              </button>
              <button className="lp-btn lp-btn--hero-ghost" onClick={() => scrollTo('services')}>
                Explore Services
              </button>
            </div>
          ...
          <div className="lp-hero__visual">
            <div className="lp-hero__graphic">
              <div className="lp-hero__graphic-header">
                <span className="lp-hero__graphic-dot" style={{ background: '#ff5f56' }} />
                <span className="lp-hero__graphic-dot" style={{ background: '#ffbd2e' }} />
                <span className="lp-hero__graphic-dot" style={{ background: '#27c93f' }} />
                <span style={{ marginLeft: 8, fontSize: '0.72rem', color: 'rgba(255,255,255,0.5)', fontWeight: 600 }}>
                  SJTMO Dashboard
                </span>
              </div>
              {[
                { icon: '🚦', label: 'Active Violations', val: 'View all pending cases', badge: 'Live', badgeClass: 'badge-green' },
                { icon: '👮', label: 'Enforcer on Duty', val: 'Manage assignments',     badge: 'Online', badgeClass: 'badge-blue' },
                { icon: '📋', label: 'Citation Issued',   val: 'Digital record updated', badge: 'New', badgeClass: 'badge-yellow' },
                { icon: '📊', label: 'Monthly Report',    val: 'Analytics & insights',   badge: 'Ready', badgeClass: 'badge-green' },
                ...
                <div className="lp-hero__graphic-row" key={label}>
                  ...
                  <span className={`lp-hero__graphic-badge ${badgeClass}`}>{badge}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="services" className="lp-section">
        <div className="lp-section__inner">
          <div className="lp-section__header">
            ...
            <h2 className="lp-section__title">Everything You Need, In One Platform</h2>
            <p className="lp-section__desc">
              From digital citation issuance to real-time analytics, SJTMO covers the full
              lifecycle of traffic enforcement and management.
            </p>
          </div>
      ...
      <section id="how-it-works" className="lp-section lp-section--alt">
        <div className="lp-section__inner">
          <div className="lp-section__header">
            ...
            <h2 className="lp-section__title">Get Started in Three Simple Steps</h2>
            <p className="lp-section__desc">
              Accessing the SJTMO system is quick and straightforward for all user types.
            </p>
          </div>
          <div className="lp-steps">
            {STEPS.map(({ icon, title, desc }, i) => (
              <div className="lp-step" key={title}>
                ...
                <div>
                  <div className="lp-step__title">Step {i + 1} — {title}</div>
        ...
        <div className="lp-section__inner">
          <div className="lp-about__inner">
            <div>
              ...
              <h2 className="lp-about__title">Serving San Jose Through Better Traffic Governance</h2>
              <p className="lp-about__body">
                The San Jose Traffic Management Office System (SJTMO) is an official digital
                platform developed to modernize traffic enforcement and management operations in
                San Jose, Occidental Mindoro. Our mission is to improve road safety, streamline
                citation processes, and provide transparent, accountable public service.
              </p>
            ...
            <div className="lp-about__visual">
              <div className="lp-about__card">
                ...
                <div className="lp-about__card-sub">
                  To provide an efficient, transparent, and accountable traffic management
                  system that promotes road safety and serves the public interest of San Jose,
                  Occidental Mindoro through the use of modern technology.
                </div>
              </div>
              ...
              {[
                {
                  ...
                  value: 'Municipal Hall, San Jose, Occidental Mindoro, Philippines',
                },
                {
                  icon: <PhoneIcon />,
                  label: 'Phone Number',
            ...
            <div className="lp-contact__form-card">
              ...
              <form onSubmit={handleContact} noValidate>
                <div className="lp-form-group">
                  <label className="lp-form-label" htmlFor="c-name">Full Name</label>
                  <input
                    id="c-name"
                ...
                <div className="lp-form-group">
                  <label className="lp-form-label" htmlFor="c-email">Email Address</label>
                  <input
                    id="c-email"
                    className="lp-form-input"
                    type="email"
                ...
                <div className="lp-form-group">
                  <label className="lp-form-label" htmlFor="c-msg">Message</label>
                  <textarea
                    id="c-msg"
      ...
      <footer className="lp-footer">
        <div className="lp-footer__top">
          ...
          <div>
            ...
            <div className="lp-footer__brand-sub">San Jose Traffic Management Office</div>
            <p className="lp-footer__brand-desc">
              An official digital platform of the local government of San Jose, Occidental
              Mindoro, dedicated to improving road safety and traffic enforcement.
            </p>
            <div className="lp-footer__socials">
              <a href="#!" className="lp-footer__social" aria-label="Facebook"><FacebookIcon /></a>
              <a href="#!" className="lp-footer__social" aria-label="Twitter"><TwitterIcon /></a>
              <a href="#!" className="lp-footer__social" aria-label="YouTube"><YoutubeIcon /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="lp-footer__col-links">
              {['Enforcer Management','Motorist Records','Citation Issuance','Reports & Monitoring'].map((s) => (
        ...
        <div className="lp-footer__bottom">
          <div className="lp-footer__bottom-inner">
            <p className="lp-footer__disclaimer">
              © {new Date().getFullYear()} San Jose Traffic Management Office — Local Government of San Jose, Occidental Mindoro.
              Official government system. All rights reserved.
            </p>
